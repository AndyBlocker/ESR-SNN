...
for (int t = time_steps; t >= 1; t--) {
    ...
    float keep_mask = keep_mask_seq_cp[prev_idx];
    ...
    grad_T_t_to_H_t = grad_T_t_to_H_t * keep_mask;
    ...
    grad_Y_t_to_T_t_1 = grad_Y_t_to_T_t_1 * keep_mask;
...
for (int t = time_steps; t >= 1; t--) {
    ...
    __half keep_mask = keep_mask_seq_cp[prev_idx];
    ...
    grad_T_t_to_H_t = __hmul(grad_T_t_to_H_t, keep_mask);
    ...
    grad_Y_t_to_T_t_1 = __hmul(grad_Y_t_to_T_t_1, keep_mask);
