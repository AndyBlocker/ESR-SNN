...
from spike_quan_wrapper_ICML import myquan_replace_resnet, SNNWrapper, remove_softmax
from spike_quan_layer import MyLayerNorm, set_init_false
...
def main(args):
    ...
    if args.model == "resnet50":
        ...
        # model = timm.create_model("resnet34",pretrained=False,checkpoint_path="/home/kang_you/.cache/torch/hub/checkpoints/resnet34.tv_in1k.bin")
    ...
    if args.mode.count("QANN") > 0:
        myquan_replace_resnet(model, args.level, args.weight_quantization_bit, is_softmax = not args.remove_softmax)
        if args.rank == 0:
            print("======================== QANN model =======================")
    ...
    max_accuracy = 0.0
    #
    test_stats = evaluate(data_loader_val, model_teacher, device, args.mode, args)
