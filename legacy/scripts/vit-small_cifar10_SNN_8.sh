...
NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port='29500' main_finetune.py \
    ...
    --finetune /home/zekai_xu/SNN/code/SpikeZIP_transformer/output_dir/T-SNN_vit_small_patch16_cifar10_relu_QANN_QAT_8/vit-small-cifar10-relu-q8-97.96.pth \
    --resume /home/zekai_xu/SNN/code/SpikeZIP_transformer/output_dir/T-SNN_vit_small_patch16_cifar10_relu_QANN_QAT_8/vit-small-cifar10-relu-q8-97.96.pth \
    --epochs 100 \
