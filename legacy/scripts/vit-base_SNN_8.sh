...
NCCL_P2P_DISABLE=1 OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port='29500' main_finetune.py \
    ...
    --finetune /home/zekai_xu/SNN/code/SpikeZIP_transformer/output_dir/T-SNN_vit_base_patch16_relu_QANN_QAT_8/checkpoint-94.pth \
    --resume /home/zekai_xu/SNN/code/SpikeZIP_transformer/output_dir/T-SNN_vit_base_patch16_relu_QANN_QAT_8/checkpoint-94.pth \
    --epochs 100 \
    ...
    --mode "SNN" --act_layer relu --eval --time_step 2000 --encoding_type rate --level 8