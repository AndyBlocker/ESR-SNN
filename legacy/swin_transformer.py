...
default_cfgs = {
    ...
    'swin_dvs_patch4_window4_128': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth',
    ),
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 drop_path=0., norm_layer=nn.LayerNorm, downsample=None, use_checkpoint=False, act_layer=nn.GELU):
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(
                ...
                drop_path=drop_path[i] if isinstance(drop_path, list) else drop_path, norm_layer=norm_layer, act_layer=act_layer)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, weight_init='',act_layer=nn.GELU, **kwargs):
        super().__init__()
...
@register_model
def swin_cifar_patch4_window7_224(pretrained=False, **kwargs):
    """ Swin-T @ 224x224, trained CIFAR10DVS
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=36, depths=(2, 2, 6, 2), num_heads=(1, 3, 6, 12), **kwargs)
    return _create_swin_transformer('swin_dvs_patch4_window4_128', pretrained=pretrained, **model_kwargs)


@register_model
def swin_dvs_patch4_window4_128(pretrained=False, **kwargs):
    """ Swin-T @ 128x128, trained CIFAR10DVS
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=24, depths=(2, 2, 6, 2), num_heads=(1, 3, 6, 12), **kwargs)
    return _create_swin_transformer('swin_dvs_patch4_window4_128', pretrained=pretrained, **model_kwargs)
