...
from spike_quan_layer_IntegerOnly import myquan_replace_integerOnly
from spike_quan_layer import MyBatchNorm1d
...
def main(args):
    ...
    if args.mode.count("QANN") > 0:
        myquan_replace_integerOnly(model, args.level, args.weight_quantization_bit, is_softmax = not args.remove_softmax)
        if args.rank == 0:
            print("======================== QANN model =======================")
